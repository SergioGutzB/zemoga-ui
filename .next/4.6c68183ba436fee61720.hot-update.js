...
})(["display:flex;flex-direction:row;justify-content:space-between;align-items:center;padding:15px 25px;background-color:", ";.title{color:#4d4d4d;font-size:24px;font-weight:200;strong{font-size:40px;}}.message{font-size:15px;font-weight:200;}.close{cursor:pointer;width:30px;height:30px;}"], __WEBPACK_IMPORTED_MODULE_1__styles_variables__["a" /* variables */].gray);

/***/ })

})
//# sourceMappingURL=4.6c68183ba436fee61720.hot-update.js.map