...
})(["display:flex;flex-direction:row;justify-content:space-between;align-items:center;padding:30px;background-color:", ";.title{font-size:30px;word-wrap:wrap;strong{font-size:40px;}}.message{font-size:14px;}.close{cursor:pointer;}"], __WEBPACK_IMPORTED_MODULE_1__styles_variables__["a" /* variables */].gray);

/***/ })

})
//# sourceMappingURL=4.b428ca24f38e67444d9b.hot-update.js.map