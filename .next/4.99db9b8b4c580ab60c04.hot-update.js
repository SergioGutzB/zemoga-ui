...
})(["display:flex;flex-direction:row;justify-content:space-between;align-items:center;padding:30px;background-color:", ";.title{font-size:30px;strong{font-size:40px;}}.message{font-size:14px;}.close{cursor:pointer;}"], __WEBPACK_IMPORTED_MODULE_1__styles_variables__["a" /* variables */].gray);

/***/ })

})
//# sourceMappingURL=4.99db9b8b4c580ab60c04.hot-update.js.map