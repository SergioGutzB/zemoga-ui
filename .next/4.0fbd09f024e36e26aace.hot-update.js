...
})(["display:flex;flex-direction:row;justify-content:space-between;align-items:center;padding:30px;background-color:", ";.title{font-size:24px;strong{font-size:40px;}}.message{font-size:14px;}.close{cursor:pointer;}"], __WEBPACK_IMPORTED_MODULE_1__styles_variables__["a" /* variables */].gray);

/***/ })

})
//# sourceMappingURL=4.0fbd09f024e36e26aace.hot-update.js.map