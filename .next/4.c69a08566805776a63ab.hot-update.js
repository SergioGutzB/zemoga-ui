...
})(["display:flex;flex-direction:row;justify-content:space-between;align-items:center;padding:30px;background-color:", ";.title{font-size:30px;strong{font-size:40px;}width:100px;}.message{font-size:14px;}.close{cursor:pointer;}"], __WEBPACK_IMPORTED_MODULE_1__styles_variables__["a" /* variables */].gray);

/***/ })

})
//# sourceMappingURL=4.c69a08566805776a63ab.hot-update.js.map