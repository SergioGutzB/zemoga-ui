...
})(["display:flex;flex-direction:row;justify-content:space-between;align-items:center;width:100%;color:white;.progressOne,.progressTwo{display:flex;flex-direction:row;align-items:center;padding:7px 10px;&__percentage{font-size:30px;font-weight:300;padding:2px 5px;line-height:25px;}}.progressOne{width:", ";background-color:", ";justify-content:flex-start;}.progressTwo{width:", ";background-color:", ";justify-content:flex-end;&__like{transform:rotate(180deg);}}"], function (props) {
...
//# sourceMappingURL=4.deb8bf2b60aac8b41d4b.hot-update.js.map