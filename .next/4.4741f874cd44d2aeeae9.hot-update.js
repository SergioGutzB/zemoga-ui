...
})(["border:none;background-color:transparent;box-sizing:border-box;border:1px solid;border-color:white;padding:8px 15px;cursor:pointer;&:hover{background-color:#ffffffac;}.label{color:white;font-size:16px;font-weight:600;}"]);

/***/ })

})
//# sourceMappingURL=4.4741f874cd44d2aeeae9.hot-update.js.map