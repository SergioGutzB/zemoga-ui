...
})(["display:flex;flex-direction:row;justify-content:space-between;align-items:center;padding:30px;background-color:", ";.title{color:#4d4d4d;font-size:24px;font-weight:200;strong{font-size:40px;}}.message{font-size:14px;font-weight:200;}.close{cursor:pointer;}"], __WEBPACK_IMPORTED_MODULE_1__styles_variables__["a" /* variables */].gray);

/***/ })

})
//# sourceMappingURL=4.4570207bb0ef8638c651.hot-update.js.map