...
var Button = __WEBPACK_IMPORTED_MODULE_0_styled_components__["a" /* default */].button.withConfig({
...
})(["border:none;width:", ";height:", ";background-color:", ";box-sizing:border-box;border:2px solid ", ";padding:", ";cursor:pointer;border:", ";.like{color:white;path{fill:white;}width:", ";height:", ";transform:rotate(", ")}"], function (props) {
  ...
  return props.desactive ? '&:hover {2px solid white}' : '';
}, function (props) {
...
//# sourceMappingURL=4.5c74b47006fe62366f21.hot-update.js.map