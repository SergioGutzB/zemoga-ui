...
var fadeIn = Object(__WEBPACK_IMPORTED_MODULE_0_styled_components__["keyframes"])(["from{transform:scale(.25);opacity:0;}to{transform:scale(1);opacity:1;}"]);
var fadeOut = Object(__WEBPACK_IMPORTED_MODULE_0_styled_components__["keyframes"])(["from{transform:scale(1);opacity:1;}to{transform:scale(.1);opacity:0;}"]);
