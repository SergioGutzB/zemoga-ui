...
})(["display:flex;flex-direction:column;justify-content:flex-end;align-items:flex-start;background-image:url(", ");background-repeat:no-repeat;background-size:cover;background-position:center;.ruling{padding:35px;&__title{position:relative;color:white;&__state{position:absolute;left:-35px;top:9px;width:40px;height:40px;}&__name{font-size:40px;font-weight:600;}}&__experience{font-size:14px;font-weight:400;margin:5px 0px;}&__message{font-size:18px;font-weight:200;margin:10px 0px;}&__actions{width:50%;display:flex;flex-direction:row;justify-content:space-between;margin:10px 0px;}}.message{flex:auto;text-align:left;font-size:15px;font-weight:200;}.close{cursor:pointer;width:30px;height:30px;}"], function (props) {
...
//# sourceMappingURL=4.d37f64336a317c944ba9.hot-update.js.map