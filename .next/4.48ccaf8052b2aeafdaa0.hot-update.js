...
})(["display:flex;flex-direction:row;justify-content:space-between;align-items:center;padding:30px;background-color:", ";.title{color:#4d4d4d;font-size:24px;font-weight:200;strong{font-size:40px;}}.message{font-size:14px;}.close{cursor:pointer;}"], __WEBPACK_IMPORTED_MODULE_1__styles_variables__["a" /* variables */].gray);

/***/ })

})
//# sourceMappingURL=4.48ccaf8052b2aeafdaa0.hot-update.js.map