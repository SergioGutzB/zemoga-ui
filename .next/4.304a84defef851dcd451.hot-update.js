...
})(["display:flex;flex-direction:row;justify-content:space-between;align-items:center;padding:15px 25px;background-color:", ";.title{color:#4d4d4d;font-size:22px;font-weight:200;strong{font-size:38px;}}.message{flex:auto;text-align:left;font-size:15px;font-weight:200;}.close{cursor:pointer;width:30px;height:30px;}"], __WEBPACK_IMPORTED_MODULE_1__styles_variables__["a" /* variables */].gray);

/***/ })

})
//# sourceMappingURL=4.304a84defef851dcd451.hot-update.js.map